...
```{R Country Net Capital Scatters, eval=FALSE, include=FALSE}
plotScat <- function(e){
...
There we a lot of graphs created, although some are show below, here are the key take a ways:
...
```{R Heat Maps, eval=FALSE, include=FALSE}
